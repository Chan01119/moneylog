...
public class MailSendService {
    ...
    public boolean senWelcomeHtmlMessage(User user) {
        ...
        try {
            ...
            html += "<p>안녕하세요<h2><a href='http://192.168.10.62:8080'>머니로그</a>에 가입하신 것을 진심으로 환영합니다.</p>";
    ...
    public boolean sendEmailVerify(String email, String token) {
        ...
        try {
            ...
            String html = "<h2>안녕하세요, <a href='http://192.168.10.30:8080'>머니로그</a>입니다</h2>";
            html += "<p><a href='http://192.168.10.30:8080/auth/email-verify/" + email + "/" + token + "'>인증하기</a></p>";
            messageHelper.setText(html, true);
